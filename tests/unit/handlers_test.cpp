...
anolis::deviceprovider::v1::ReadSignalsResponse
make_response(int64_t value_seconds) {
...
anolis::deviceprovider::v1::ReadSignalsRequest make_request(int64_t min_seconds,
                                                            bool has_min) {
